// AUTO-GENERATED by make-playbook.js — edit the script, not this file.
...
export const playbookSections: PlaybookSection[] = [
  {
    ...
    "blocks": [
      {
        "type": "p",
        "text": "Cancellations and callouts are the most expensive problem in an ABA clinic that nobody puts on a dashboard. Industry cancellation rates commonly run around 30%. Every cancelled session is two losses at once: the revenue for that hour, and — the one that matters more — a unit of authorized care a child was supposed to receive."
      },
      {
        "type": "p",
        "text": "This playbook is not about billing more. It's about making sure the hours already approved on the treatment plan actually happen, and that the ones that fall through get recovered where it's clinically appropriate to do so. Precision over volume."
      }
    ]
  },
  {
    ...
    "blocks": [
      {
        "type": "p",
        "text": "When a session cancels, most clinics log it and move on. A recovery waterfall instead runs the cancellation through a sequence of options, stopping at the first one that works:"
      },
      {
        "type": "list",
        "items": [
      ...
      {
        "type": "p",
        "text": "The goal isn't to force every hour back onto the calendar. It's to stop treating 'cancelled' as automatically meaning 'lost.'"
      }
    ]
  },
  {
    ...
    "blocks": [
      {
        "type": "sub",
        "text": "The cheapest hour to recover is the one that never cancels."
      },
      {
        "type": "list",
        "items": [
  ...
  },
  {
    ...
    "blocks": [
      {
        "type": "sub",
        "text": "An open authorized hour is an asset with a short shelf life. Have a system ready before it appears."
      },
      {
        "type": "list",
        "items": [
      ...
      {
        "type": "p",
        "text": "One firm rule: never bill for the sake of billing. Every recovered or converted hour has to be clinically appropriate and properly authorized. Recovery is about not wasting approved care — not about manufacturing it."
      }
    ]
  },
  {
    ...
    "blocks": [
      {
        "type": "p",
        "text": "You can't recover what you don't measure. Track these monthly — they're enough to manage the whole problem:"
      },
      {
        "type": "list",
        "items": [
