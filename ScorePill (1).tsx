  ...
  return (
    <>
      <PageHeader
        ...
        description="Find keyword clusters, local variations, high-intent landing page ideas, Google Trends links, and CSV exports before building pages or campaigns."
      />
      <KeywordResearchTool />
